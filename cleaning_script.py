...
print('cleaning')
# go to the log folder then get the recent log filename
try:
    move_to_log_folder()
    log_filename = get_recent_log()
except:
    print('error')
print(os.getcwd())
print('got '+log_filename)
...
#there are some lines where the pipe separator is missing, causing null values in country columns (lines 1007459-1007463)
...
#some of them are negatives (line 1243014 - 1243017)
...
# save dfs
save_df(streams_df, 'country_'+log_filename)
